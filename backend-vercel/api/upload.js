// api/upload.js — carica un'immagine (locandina) e restituisce l'URL pubblico
// POST protetto da password. Body JSON: { name, dataUrl }
// Salva su Vercel Blob (archivio file). Su Vercel: Storage -> Create -> Blob.
